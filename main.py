...
curves = {
    ...
    "1.2.643.2.2.35.1": CURVES["id-tc26-gost-3410-12-256-paramSetB"], # CpSet A
    "1.2.643.2.2.35.2": CURVES["id-tc26-gost-3410-12-256-paramSetC"], # CpSet B
    "1.2.643.2.2.35.3": CURVES["id-tc26-gost-3410-12-256-paramSetD"], # CpSet C
...
if fp == bytes(header["keyContainerContent"]["primaryFP"]):
    ...
    print("Если вы считаете что это ошибка - создайте issue")